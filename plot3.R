...
png(filename="/Users/Samer/datasciencecoursera/plot3.png",width=480,height=480,units="px")
...
legend("topright", col = c("black","red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2","Sub_metering_3"),lty=1,col)
